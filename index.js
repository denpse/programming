...
// comment in javascrpit Used to explain code​​​​ comment have two way to write comment in javascript // and /* */:
...
// Declare a variable named `a` with the value 5, and another variable `b`. Assign `a` to `b`b
// var a;
// a = 5;
// var b;
// b = a;:
